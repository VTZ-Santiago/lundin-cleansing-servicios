...
CANONICAL_SCHEMA: list[CanonicalColumn] = [
    ...
    CanonicalColumn("pending_delivery_qty",    "Por entregar (cantidad)",             "float", True,  False, False, "quantity"),
    ...
    CanonicalColumn("pending_delivery_value",  "Por entregar (valor)",                "float", True,  False, False, "pricing"),
